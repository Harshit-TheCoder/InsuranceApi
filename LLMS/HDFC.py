...
system_prompt = (
    ...
    "If you don't know the answer, SAY 'Sorry, but I failed to find the relevant details from my database with the details you provided.' and DISPLAY {hdfc_policy}."
    "YOUR ARE TRAINED WITH THESE POLICIES {hdfc_policy}"
