...
# Create vector store
PERSIST_DIR = "StarHealth_Embeddings"
...
system_prompt = (
    ...
    "If you don't know the answer, SAY 'Sorry, but I failed to find the relevant details from my database with the details you provided.' and DISPLAY {starhealth_policy}."
    "YOUR ARE TRAINED WITH THESE POLICIES {starhealth_policy}"
