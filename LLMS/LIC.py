...
# Create vector store
PERSIST_DIR = "LIC_Embeddings"

if os.path.exists(PERSIST_DIR):
    vectorstore = Chroma(persist_directory=PERSIST_DIR, embedding_function=embeddings)
else:
    # Load and split documents
    DOCS_FOLDER = "documents/LIC"
    documents = []
...
system_prompt = (
    ...
    "If you don't know the answer, SAY 'Sorry, but I failed to find the relevant details from my database with the details you provided.' and DISPLAY {lic_policy}."
    "YOUR ARE TRAINED WITH THESE POLICIES {lic_policy}"
